...
public class Fix extends JFrame {
	...
	public Fix() {
		...
		nameField.setBounds(253, 130, 138, 37);
		...
		kanaField.setBounds(253, 175, 138, 37);
		...
		flagField.setBounds(259, 372, 133, 42);
