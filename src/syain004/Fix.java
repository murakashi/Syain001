...
public class Fix extends JFrame {
	...
	public Fix() {
		...
		flagComboBox.setModel(new DefaultComboBoxModel(new String[] { "未選択", "無効（データ復元）" }));
		flagComboBox.setFont(new Font("MS UI Gothic", Font.BOLD, 23));
		flagComboBox.setBounds(209, 403, 193, 41);
		contentPane.add(flagComboBox);
		...
		fixErrorLabel.setFont(new Font("MS UI Gothic", Font.BOLD, 25));
		fixErrorLabel.setBounds(164, 462, 431, 43);
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (year.equals("") || month.equals("") || day.equals("")) {
					fixErrorLabel.setText("日付に不備があります。");
				} else {
				...
				if (name.equals("") && kana.equals("") && ken.equals("") && city.equals("")
						&& dept.equals("") && pass.equals("") && sei.equals("") && birth.equals("") && kengen.equals("")) {
				...
				if (check == true) {
					...
					if (num == 0) {
						fixErrorLabel.setText("削除されているデータは修正できません");
					} else if(num == 2){
						fixErrorLabel.setText("入力値が正しくありません");
					}else {
						Result result = new Result();
						result.setVisible(true);
		...
		button.setBounds(185, 520, 138, 40);
		...
		recoveryButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(num == 0) {
					fixErrorLabel.setText("このデータは削除されていません");
				}else {
					Result result = new Result();
					result.setVisible(true);
		...
		recoveryButton.setBounds(346, 520, 161, 40);
