...
public class DBCls1 {
	...
	public ArrayList<String[]> getSyainData2(String w1, String w2, String w3) {
		...
		if (b1 == false && b2 == false && b3 == false) {
			zyoken = "where 削除フラグ = 0 and フリガナ like'%" + w1 + "%' and 部門ID = '" + w2 + "' and 性別 = '" + w3 + "'";
		}

		//シメイだけ入ってる
		if (b1 == false && b2 == true && b3 == true) {
			zyoken = "where 削除フラグ = 0 and フリガナ like'%" + w1 + "%'";
		}

		//部門IDだけ入ってる
		if (b1 == true && b2 == false && b3 == true) {
			zyoken = "where 削除フラグ = 0 and 部門ID = '" + w2 + "'";
		}

		//性別だけ入ってる
		if (b1 == true && b2 == true && b3 == false) {
			zyoken = "where 削除フラグ = 0 and 性別 = '" + w3 + "'";
		}

		//シメイと部門IDだけ入っている
		if (b1 == false && b2 == false && b3 == true) {
			zyoken = "where 削除フラグ = 0 and フリガナ like'%" + w1 + "%' and 部門ID = '" + w2 + "'";
		}

		//シメイと性別だけ入っている
		if (b1 == false && b2 == true && b3 == false) {
			zyoken = "where 削除フラグ = 0 and フリガナ like'%" + w1 + "%' and 性別 = '" + w3 + "'";
		}

		//部門と性別だけ入っている
		if (b1 == true && b2 == false && b3 == false) {
			zyoken = "where 削除フラグ = 0 and 部門ID = '" + w2 + "' and 性別 = '" + w3 + "'";
		}

		//何も入っていない
		if (b1 == true && b2 == true && b3 == true) {
			zyoken = "where 削除フラグ = 0";
		}
	...
	public ArrayList<String[]> getSyainData3(String w1, String w2, String w3) {
		...
		//条件全部入ってる
		if (b1 == false && b2 == false && b3 == false) {
			zyoken = "where フリガナ like'%" + w1 + "%' or 部門ID = '" + w2 + "' or 性別 = '" + w3 + "'";
		}

		//シメイだけ入ってる
		if (b1 == false && b2 == true && b3 == true) {
			zyoken = "where フリガナ like'%" + w1 + "%'";
		}

		//部門IDだけ入ってる
		if (b1 == true && b2 == false && b3 == true) {
			zyoken = "where 部門ID = '" + w2 + "'";
		}
		...
		//シメイと部門IDだけ入っている
		if (b1 == false && b2 == false && b3 == true) {
			zyoken = "where フリガナ like'%" + w1 + "%' or 部門ID = '" + w2 + "'";
		}

		//シメイと性別だけ入っている
		if (b1 == false && b2 == true && b3 == false) {
			zyoken = "where フリガナ like'%" + w1 + "%' or 性別 = '" + w3 + "'";
		}

		//部門と性別だけ入っている
		if (b1 == true && b2 == false && b3 == false) {
			zyoken = "where 部門ID = '" + w2 + "' or 性別 = '" + w3 + "'";
		}
